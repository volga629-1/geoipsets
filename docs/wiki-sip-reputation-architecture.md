...
High-confidence scanner patterns such as `TUFAN-Scanner`, SIP `file:///` URI
probes, and SIP `../` path traversal probes including `%00/../` variants are
also flagged as reputation signals.
